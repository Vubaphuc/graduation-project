...
import { useLazyFindProductUnderRepairAllQuery } from "../../../../app/apis/receptionist/productApi";
import { getStatusLabel } from "../../../formHTML/enum";
import ReactPaginate from "react-paginate";

function RecepProductUnderRepairList() {
                                                ...
                                                <tbody>
                                                    {productData.data.map((product) => (
                                                        <tr key={product.id}>
                                                            <td>
                                                                <Link
                                                                    to={`/receptionist/change-engineer/${product.id}`}
...
export default RecepProductUnderRepairList;