...
import { useLazyFindProductWaitingForRepairAllQuery } from "../../../../app/apis/receptionist/productApi";
import { getStatusLabel } from "../../../formHTML/enum";

function RecepTransferProductList() {
                                                ...
                                                <tbody>
                                                    {productData.data.map((product) => (
                                                        <tr key={product.id}>
                                                            <td>
                                                                <Link
                                                                    to={`/receptionist/transfer-product/${product.id}`}
...
export default RecepTransferProductList;