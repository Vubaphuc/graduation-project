...
import { useLazyFindReceiptAllQuery, useLazyFindReceiptStatusTrueAllQuery } from "../../../../app/apis/receptionist/productApi";

function RecepReceiptList() {
                                                    ...
                                                    <tbody>
                                                        {receiptData.data.map((receipt) => (
                                                            <tr key={receipt.id}>
                                                                <td>
                                                                    <Link
                                                                        to={`/receptionist/receipt-detail/${receipt.id}`}
                                                                ...
                                                                <td>
                                                                    <Link
                                                                        ...
                                                                        className="text-decoration-none"
                                                                    >
                                                                        {receipt?.product.customer.fullName}
                                                                    </Link>
                                                                </td>
                                                                <td>{receipt.product.customer.email}</td>
                                                                <td>{receipt.product.customer.phoneNumber}</td>
                                                                <td>{receipt.product.nameModel}</td>
                                                                <td>{receipt.product.ime}</td>
...
export default RecepReceiptList;