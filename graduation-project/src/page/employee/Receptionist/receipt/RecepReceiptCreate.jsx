...
import { useCreateBillMutation, useCreateReceiptMutation, useFindProductByIDQuery } from "../../../../app/apis/receptionist/productApi";
import { toast } from "react-toastify";
import { useSelector } from "react-redux";



function RecepReceiptCreate() {
  ...
  const handleClickCreateReceipt = () => {
    ...
    createReceipt(productId)
      ...
      .then((res) => {
        ...
        setTimeout(() => {
            const url = `http://localhost:8080/employee/api/v1/receipt-pdf/${res.data.id}`;
...
export default RecepReceiptCreate;
