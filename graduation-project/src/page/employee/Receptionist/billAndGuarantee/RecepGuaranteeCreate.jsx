...
import { useCreateNewGuaranteeMutation, useFindProductByIDQuery } from "../../../../app/apis/receptionist/productApi";
            ...
            <section className="content">
                <div className="container-fluid">
                    <div className="row py-2">
                        <div className="col-6">
                            <Link to={"/receptionist/products"} className="btn btn-default">
