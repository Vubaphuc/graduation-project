...
import { useFindProductGuaranteeByIDQuery, useLazyGetListComponentPhoneQuery } from "../../../../app/apis/engineer/engineerProductApi";
import { getComponents, getStatus } from "../../../formHTML/options";
import { Controller } from "react-hook-form";
import Select from "react-select";
import hookUpdateInformationProductGuaranteeRepair from "../../../hookForm/hook/hookEngineer/hookUpdateInformationProductGuaranteeRepair";

function EngiInformationProductGuaranteeRepair() {
    ...
    const {
        ...
        handleSubmit,
        errors,
        onUpdateInformationProductGuaranteeRepair,
    } = hookUpdateInformationProductGuaranteeRepair(productId);

    const { data: productData, isLoading: productLoading } =
        useFindProductGuaranteeByIDQuery(productId);

    const [getComponent, { data: componentData, isLoading: componentLoading }] =
        ...
        <>
            <section className="content">
                <div className="container-fluid">
                    <form onSubmit={handleSubmit(onUpdateInformationProductGuaranteeRepair)}>
                        <div className="row py-2">
                            <div className="col-6">
                                <Link to={"/engineer"} className="btn btn-default">
...
export default EngiInformationProductGuaranteeRepair;