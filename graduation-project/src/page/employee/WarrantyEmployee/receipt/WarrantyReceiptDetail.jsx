...
import { useFindReceiptByIdQuery } from "../../../../app/apis/warrantyEmoloyee/warrantyProductApi";
import hookWarrantyUpdateReceipt from "../../../hookForm/hook/hookWarranty/hookWarrantyUpdateReceipt";



function WarrantyReceiptDetail() {
    const { receiptId } = useParams();
    const navigate = useNavigate();
    const [currentDate, setCurrentDate] = useState("");
    const invoiceRef = useRef(null);

    const { control, handleSubmit, errors, onUpdateReceipt } = hookWarrantyUpdateReceipt(receiptId);
                        ...
                        <table className="invoice-table">
                            ...
                            <tbody>
                                ...
                                <tr className="row-data">
                                    <td>Customer Name</td>
                                    <td>{receiptData?.productGuarantee.customer.fullName}</td>
                                </tr>
                                <tr className="row-data">
                                    <td>Phone</td>
                                    <td>{receiptData?.productGuarantee.customer.phoneNumber}</td>
                                </tr>
                                <tr className="row-data row-botton-boder">
                                    <td>Email</td>
                                    <td>{receiptData?.productGuarantee.customer.email}</td>
                                </tr>
                                <tr className="row-data">
                                    <td>Model Name</td>
                                    <td>{receiptData?.productGuarantee.nameModel}</td>
                                </tr>
                                <tr className="row-data">
                                    <td>IME</td>
                                    <td>{receiptData?.productGuarantee.ime}</td>
                                </tr>
                                <tr>
                                    <td>Ngày Nhận</td>
...
export default WarrantyReceiptDetail;
