...
import { useLazyFindProductNoCreateReceiptAllQuery } from "../../../../app/apis/warrantyEmoloyee/warrantyProductApi";
import { getStatusLabel } from "../../../formHTML/enum";

function WarrantyProductNoCreateReceiptList() {
                                                ...
                                                <tbody>
                                                    {productData.data.map((product) => (
                                                        <tr key={product.id}>
                                                            <td>
                                                                <Link
                                                                    to={`/warranty/receipt/${product.id}`}
...
export default WarrantyProductNoCreateReceiptList;