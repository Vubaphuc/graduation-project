...
import { useLazyFindProductDeliveredAllQuery } from "../../../../app/apis/warrantyEmoloyee/warrantyProductApi";
import { getStatusLabel } from "../../../formHTML/enum";
import ReactPaginate from "react-paginate";

function WarrantyProductDeliveredList() {
                                                ...
                                                <tbody>
                                                    {productData.data.map((product) => (
                                                        <tr key={product.id}>
                                                            <td>
                                                                <Link
                                                                    to={`/warranty/create-guarantee/${product.id}`}
...
export default WarrantyProductDeliveredList;