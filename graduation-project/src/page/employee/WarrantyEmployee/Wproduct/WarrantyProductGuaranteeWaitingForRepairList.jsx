...
import { useLazyFindProductGuaranteeWaitingForRepairAllQuery } from "../../../../app/apis/warrantyEmoloyee/warrantyProductApi";

function WarrantyProductGuaranteeWaitingForRepairList() {
                                                ...
                                                <tbody>
                                                    {productData.data.map((product) => (
                                                        <tr key={product.id}>
                                                            <td>
                                                                <Link
                                                                    to={`/warranty/product-guarantee/${product.id}`}
...
export default WarrantyProductGuaranteeWaitingForRepairList;